!function (e) {
    ...
    e.exports = function (e) {
        ...
        function r() {
            ...
            } else t = document.documentElement.scrollTop || m.scrollTop;
        ...
        function s(t) {
            if (e.scrollContainer && document.querySelector(e.scrollContainer)) {
                var n;
                n = document.querySelector(e.scrollContainer).scrollTop
            } else n = document.documentElement.scrollTop || m.scrollTop;
            ...
            if (h && null !== document.querySelector(e.tocSelector) && l.length > 0) {
                ...
                var u = document.querySelector(e.tocSelector).querySelector("." + e.linkClass + ".node-name--" + o.nodeName + '[href="#' + o.id.replace(/([ #;&,.+*~':"!^$[\]()=>|\/@])/g, "\\$1") + '"]');
